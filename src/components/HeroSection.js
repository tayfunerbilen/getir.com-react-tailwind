...
function HeroSection() {
	...
	return (
		<div
			className="h-[500px] bg-purple-500 relative before:bg-gradient-to-r before:from-purple-600 before:to-transparent before:absolute before:inset-0 before:w-full before:h-full before:z-10">
			...
			<div className="absolute inset-0 px-8 z-[40] flex items-center">
				<div className="container flex mx-auto justify-between items-center">
					...
					<div className="w-[400px] bg-white rounded-lg px-5 py-6">
